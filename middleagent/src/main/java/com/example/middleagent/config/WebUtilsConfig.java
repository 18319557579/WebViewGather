...
public class WebUtilsConfig implements Parcelable {
    ...
    public WebUtilsConfig setErrorLayoutId(int errorLayoutId) {
    ...
    public WebUtilsConfig setTitleTextColor(int titleTextColor) {
    ...
    public WebUtilsConfig setBackTextColor(int backTextColor) {
    ...
    public void readFromParcel(Parcel source) {
        ...
        this.showBackText = source.readByte() != 0;
        this.titleBackgroundRes = source.readInt();
        this.titleBackgroundColor = source.readInt();
        this.backBtnRes = source.readInt();
        this.moreBtnRes = source.readInt();
        this.showMoreBtn = source.readByte() != 0;
        this.showTitleLine = source.readByte() != 0;
        this.titleLineColor = source.readInt();
        this.showTitleView = source.readByte() != 0;
